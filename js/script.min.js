...
},b.prototype.current=function(){var b=this._core.relative(this._core.current());return a.grep(this._pages,a.proxy(function(a){return a.start<=b&&a.end>=b},this)).pop()},b.prototype.getPosition=function(b){var c,d,e=this._core.settings;return"page"==e.slideBy?(c=a.inArray(this.current(),this._pages),d=this._pages.length,b?++c:--c,c=this._pages[(c%d+d)%d].start):(c=this._core.relative(this._core.current()),d=this._core.items().length,b?c+=e.slideBy:c-=e.slideBy),c},b.prototype.next=function(b){a.proxy(this._overrides.to,this._core)(this.getPosition(!0),b)},b.prototype.prev=function(b){a.proxy(this._overrides.to,this._core)(this.getPosition(!1),b)},b.prototype.to=function(b,c,d){var e;d?a.proxy(this._overrides.to,this._core)(b,c):(e=this._pages.length,a.proxy(this._overrides.to,this._core)(this._pages[(b%e+e)%e].start,c))},a.fn.owlCarousel.Constructor.Plugins.Navigation=b}(window.Zepto||window.jQuery,window,document),$("document").ready(function(){var a=1,b=$(".result-block");$("body").attr("id","all");var c=function(a){var b=a.parent().parent().parent().parent().attr("id");$("#"+b).modal("hide"),a.parent().parent().parent().removeClass("flipOutX")};b.click(function(){var a=$(this).attr("id"),b=a.replace("result","extra"),c=$("#"+b);c.modal("show")}),$(".navlink").click(function(){$(".navlink").each(function(){$(this).removeClass("active")}),$(this).addClass("active");var a=$(this).text();$("body").attr("id",a.toLowerCase().replace(/ /g,"-"))}),$("#exportButton").click(function(){$("#cart").modal("hide"),$("#export").modal("show")}),b.each(function(){$(this).find(".number").html(a),a++}),$(".close-button").click(function(a){a.preventDefault();var b=$(this);b.parent().parent().parent().addClass("flipOutX"),setTimeout(c,2200,b)}),$(".owl-carousel").owlCarousel({items:1,loop:!1,nav:!1,dots:!0,dotsData:!0})});