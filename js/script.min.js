...
},b.prototype.current=function(){var b=this._core.relative(this._core.current());return a.grep(this._pages,a.proxy(function(a){return a.start<=b&&a.end>=b},this)).pop()},b.prototype.getPosition=function(b){var c,d,e=this._core.settings;return"page"==e.slideBy?(c=a.inArray(this.current(),this._pages),d=this._pages.length,b?++c:--c,c=this._pages[(c%d+d)%d].start):(c=this._core.relative(this._core.current()),d=this._core.items().length,b?c+=e.slideBy:c-=e.slideBy),c},b.prototype.next=function(b){a.proxy(this._overrides.to,this._core)(this.getPosition(!0),b)},b.prototype.prev=function(b){a.proxy(this._overrides.to,this._core)(this.getPosition(!1),b)},b.prototype.to=function(b,c,d){var e;d?a.proxy(this._overrides.to,this._core)(b,c):(e=this._pages.length,a.proxy(this._overrides.to,this._core)(this._pages[(b%e+e)%e].start,c))},a.fn.owlCarousel.Constructor.Plugins.Navigation=b}(window.Zepto||window.jQuery,window,document),$("document").ready(function(){function a(a){for(var b=window.location.search.substring(1),c=b.split("&"),d=0;d<c.length;d++){var e=c[d].split("=");if(e[0]==a)return e[1]}}$(".result-block").click(function(){var a=$(this).attr("id"),b=a.replace("result","extra"),c=$("#"+b);c.slideToggle()}),$("#exportButton").click(function(){$("#cart").modal("hide"),$("#export").modal("show")}),$("#search").submit(function(a){a.preventDefault();var b="http://homercreative.github.io/prototype/search-results.html",c="?search="+$("#searchText").val();console.log(b+c+""),window.location.href=b+c+""}),$(".owl-carousel").owlCarousel({items:1,loop:!0,margin:10,nav:!1,dots:!0,dotsData:!0});var b=decodeURI(a("search"));"undefined"!=b&&$("#searchText").val(b)});